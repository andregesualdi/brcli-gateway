...
export default function makeRedirectPost(gateway) {
    return async function redirecionarMetodoPost({headers, params, body}) {
        ...
        return await gateway.redirectPost(url, redirectBody, redirectHeaders);
    }
}
